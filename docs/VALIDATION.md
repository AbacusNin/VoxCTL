...
- The shipped files: the service worker caches every runtime file and nothing missing, every element id app.js binds exists, the version is 0.3.2 wherever it is shown, the manifest lists both icons, and no em dash, en dash or curly quote appears anywhere.
...
- The service worker registered, activated and filled the voxctl-v0.3.2 cache.
